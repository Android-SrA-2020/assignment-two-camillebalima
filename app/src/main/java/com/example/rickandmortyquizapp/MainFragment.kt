...
import com.example.rickandmortyquizapp.MainFragmentDirections
import com.example.rickandmortyquizapp.Question
import com.example.rickandmortyquizapp.R
import com.example.rickandmortyquizapp.databinding.FragmentMainBinding
...
class MainFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            btnCheat.setOnClickListener{
                ...
                val question = listQuestion[questionIndex].textResId
    ...
    private fun updateView(questionId : Int) {
        ...
        binding.apply {
            lblQuestion.setText(listQuestion[questionId].textResId)
        }
